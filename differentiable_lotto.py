...
from game import Game, run_PSRO_uniform, run_PSRO_uniform_weaker, run_PSRO_uniform_stronger
...
if __name__ == "__main__":
    def demo(improvement_function, gif_file_name="demo_PSRO"):
        ...
        try:
            from differentiable_lotto_vis import gif_from_matchups
            gif_path = gif_from_matchups(
                game, agents_history, path=f"out/{gif_file_name}.gif",
